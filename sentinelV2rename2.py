...
def process_sentinel():
    ...
    for img in list_image:
        ...
        for tile in list_67:
            ...
            print os.path.join(output_dir , dalle_input)
            print os.path.join(output_dir, dalle_out)
            os.rename(os.path.join(output_dir , dalle_input), os.path.join(output_dir, dalle_out))
