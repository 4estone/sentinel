...
def download_sentinel():
    date_img = '2017/2/16'##'2016/9/22' #'2016/6/24'#'2016/5/5'  '2016/12/1' '2016/1/26
    ...
    list_Z = ['32TMS','32TLS','32TLR','32TMR']
    ...
    win_32TMS =  {'ul_x':'342000', 'ul_y':'5160000', 'lr_x':'445000', 'lr_y':'5100000'}
    win_32TMR = {'ul_x':'342000' ,'ul_y':'5100000' ,'lr_x':'445000' ,'lr_y':'5060000'}

    win_32TLS = {'ul_x':'360000', 'ul_y':'5160000', 'lr_x':'400000', 'lr_y':'5100000'}
    win_32TLR =  {'ul_x':'360000', 'ul_y':'5100000', 'lr_x':'400000', 'lr_y':'5060000'}

    dict_67 = {'32TMS':win_32TMS,'32TMR':win_32TMR, '32TLS':win_32TLS, '32TLR':win_32TLR}
